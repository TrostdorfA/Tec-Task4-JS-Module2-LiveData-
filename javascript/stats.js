const data = {
  ...
  events: [
    ...
    },
    {
      ...
      date: "2022-9-15",
      description:
        "Spiderman's Premier in 3d, the start of an epic saga with your favourite superheroes.",
      category: "Cinema",
      place: "Room D1",
      capacity: "9000",
      estimate: "9000",
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Feriadecomidas3.jpg",
      name: "Japanese style",
      date: "2021-06-15",
      description:
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Feriadecomidas4.jpg",
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Feriadecomidas5.jpg",
      name: "Take away",
      date: "2021-10-12",
      description:
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Feriadecomidas6.jpg",
      name: "Italian style",
      date: "2021-10-12",
    ...
    },
    {
      ...
      date: "2021-10-06",
      description:
        "Come get novels from some of the most acclaimed literature genres.",
      category: "Book Exchange",
      place: "Room D1",
      capacity: "14000",
      assistance: "13000",
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Fiestadedisfraces3.jpg",
      name: "Comicon 2022",
      date: "2022-02-12",
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Fiestadedisfraces4.jpg",
      name: "Spring Day",
      date: "2022-09-21",
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Fiestadedisfraces5.jpg",
      name: "Cultures",
      date: "2021-06-21",
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Fiestadedisfraces6.jpg",
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Fiestadedisfraces7.jpg",
      name: "Epic party",
      date: "2021-09-23",
      description:
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Fiestadedisfraces8.jpg",
      name: "Halloween 2022",
      date: "2022-10-31",
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Conciertodemusica3.jpg",
      name: "Popular Music",
      date: "2021-05-22",
      description:
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Conciertodemusica4.jpg",
      name: "Classics",
      date: "2021-05-22",
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Conciertodemusica5.jpg",
      name: "Opera",
      date: "2022-05-22",
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Conciertodemusica6.jpg",
      name: "Reggaeton 2022",
      date: "2022-06-23",
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Conciertodemusica7.jpg",
      name: "Metallica in Buenos Aires",
      date: "2021-06-23",
      description:
        "We'll be having three opportunities for you to come listen to this 80s mythical band's hits.",
      category: "Music Concert",
      place: "Buenos Aires",
      capacity: "138000",
      assistance: "137560",
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Conciertodemusica8.jpg",
      name: "San Francisco's Symphony",
      date: "2021-06-23",
      description:
        "You can't miss the opportunity to come see one of the world's best symphonies live.",
      category: "Music Concert",
      place: "Buenos Aires",
      capacity: "38000",
      assistance: "36560",
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Salidaalmuseo2.jpg",
      name: "Abstract Art",
      date: "2022-11-02",
      description:
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Salidaalmuseo3.jpg",
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Salidaalmuseo4.jpg",
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Salidaalmuseo6.jpg",
      name: "Acropolis",
      date: "2021-11-02",
      description:
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Salidaalmuseo7.jpg",
      name: "British Museum",
      date: "2022-09-02",
    ...
    },
    {
      ...
      date: "2022-3-11",
      description:
        "New characters, new adventures and a world in which they are not welcomed.",
      category: "Cinema",
      place: "Room D2",
      capacity: "10000",
      estimate: "10000",
    ...
    },
    {
      ...
      image:
        "https://amazingeventsapi.herokuapp.com/api/img/Feriadecomidas1.jpg",
...
// La Api esta caida, no se puede probar, usar el array data

let dataEvents = [...data.events]

// Crear un array con los eventos ordenados por capacidad
...
let eventsByPercentage = dataEvents
...
const dateToCompareFormat = new Date(
  dateSplit[0],
  dateSplit[1] - 1,
  dateSplit[2]
)

const dateTimeStamp = dateToCompareFormat.getTime()

function dateConverter(event) {
  let dateEventToCompare
  let dateEventSplit
  let dateEventToCompareFormat
  let dateEventTimeStamp
  dateEventToCompare = event.date
  dateEventSplit = dateEventToCompare.split("-")
  dateEventToCompareFormat = new Date(
    dateEventSplit[0],
    dateEventSplit[1] - 1,
    dateEventSplit[2]
  )
  dateEventTimeStamp = dateEventToCompareFormat.getTime()
  return dateEventTimeStamp
}

// Crear un array con los eventos futuros
...
function incomesFuture(event) {
  let incomes = event.estimate * event.price
  return incomes
}

function incomesPast(event) {
  let incomes = event.assistance * event.price
  return incomes
}

// Calculo de ingresos de eventos futuros

let eventsFutureIncomes = eventsFuture
  .filter((event) => event.estimate)
...
let eventsPastIncomes = eventsPast
  .filter((event) => event.assistance)
...
function upcomingEventsAttendancePercentage(event) {
  let percentage = (event.estimate * 100) / event.capacity
  return percentage
}

let upcomingEventsAttendancePercentageArray = eventsFuture
  .filter((event) => event.estimate)
  .map((event) => upcomingEventsAttendancePercentage(event))

let upcomingEventsAttendancePercentageAverage =
  upcomingEventsAttendancePercentageArray.reduce(
    (acc, event) => acc + event,
    0
...
function pastEventsAttendancePercentage(event) {
  let percentage = (event.assistance * 100) / event.capacity
  return percentage
}

let pastEventsAttendancePercentageArray = eventsPast
  .filter((event) => event.assistance)
  .map((event) => pastEventsAttendancePercentage(event))
...
topPercentageAndEstimate.forEach((event) => {
  ...
  colHighestAssistance.appendChild(divHighestAssistance)
})
...
lowPercentageAndEstimate.forEach((event) => {
  ...
  colLowestAssistance.appendChild(divLowestAssistance)
})

// Columna de mayor capacidad

const colHighestCapacity = document.getElementById("larg-capacity")
topCapacity.forEach((event) => {
  let divHighestCapacity = document.createElement("div")
  divHighestCapacity.innerHTML = `${event.name} - ${event.capacity}`
  colHighestCapacity.appendChild(divHighestCapacity)
})

// Estadisticas de eventos futuros por categoria
// Columna de categorias de eventos futuros

const colCategories = document.getElementById("categories-stats")
eventsCategoriesNoRepeat.forEach((category) => {
  let divCategories = document.createElement("div")
  divCategories.innerHTML = category
  colCategories.appendChild(divCategories)
})

// Columna de ingresos de eventos futuros por categoria

const colIncomes = document.getElementById("revenue-stats")
eventsCategoriesNoRepeat.forEach((category) => {
  let divIncomes = document.createElement("div")
  let incomes = eventsFuture
    .filter((event) => event.category === category)
    .map((event) => incomesFuture(event))
  let incomesTotal = incomes.reduce((acc, event) => acc + event, 0)
  divIncomes.innerHTML = `$${incomesTotal}`
  colIncomes.appendChild(divIncomes)
})

// Columna de porcentaje de asistencia de eventos futuros por categoria

const colAssistance = document.getElementById("assistance-stats")
eventsCategoriesNoRepeat.forEach((category) => {
  let divAssistance = document.createElement("div")
  let assistance = eventsFuture
    .filter((event) => event.category === category)
    .map((event) => upcomingEventsAttendancePercentage(event))
  let assistanceAverage =
    assistance.reduce((acc, event) => acc + event, 0) / assistance.length
  divAssistance.innerHTML = `${assistanceAverage.toFixed(2)}%`
  colAssistance.appendChild(divAssistance)
})

// Estadisticas de eventos pasados por categoria
// Columna de categorias de eventos pasados

const colPastCategories = document.getElementById("past-categories-stats")
eventsPastCategoriesNoRepeat.forEach((category) => {
  let divPastCategories = document.createElement("div")
  divPastCategories.innerHTML = category
  colPastCategories.appendChild(divPastCategories)
})

// Columna de ingresos de eventos pasados por categoria

const colPastIncomes = document.getElementById("past-revenue-stats")
eventsPastCategoriesNoRepeat.forEach((category) => {
  let divPastIncomes = document.createElement("div")
  let incomes = eventsPast
    .filter((event) => event.category === category)
    .map((event) => incomesPast(event))
  let incomesTotal = incomes.reduce((acc, event) => acc + event, 0)
  divPastIncomes.innerHTML = `$${incomesTotal}`
  colPastIncomes.appendChild(divPastIncomes)
})

// Columna de porcentaje de asistencia de eventos pasados por categoria

const colPastAssistance = document.getElementById("past-assistance-stats")
eventsPastCategoriesNoRepeat.forEach((category) => {
  let divPastAssistance = document.createElement("div")
  let assistance = eventsPast
    .filter((event) => event.category === category)
    .map((event) => pastEventsAttendancePercentage(event))
  let assistanceAverage =
    assistance.reduce((acc, event) => acc + event, 0) / assistance.length
  divPastAssistance.innerHTML = `${assistanceAverage.toFixed(2)}%`
  colPastAssistance.appendChild(divPastAssistance)
})
